        ...
        <div class="row mt-3">
            <div class="col-md-6">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="referenceNote" placeholder="Enter reference note">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="action-buttons">
                    ...
                    <button class="btn btn-primary" id="printButton">Print Bill</button> {{-- <button class="btn btn-success" id="paymentButton">Payment</button> --}}
                    <button class="btn btn-success" id="paymentButton" data-toggle="modal" data-target="#myModal">Payment</button>
                </div>
                ...
                <div class="products">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3">
                            <img src="{{ asset('storage') }}/{{ $item->image ?? '' }}" alt="{{ $item->name }}" data-name="{{ $item->name }}" data-id="{{ $item->id }}" data-price="{{ $item->price }}">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <!-- Payment Note Field -->
                        <input type="text" class="form-control payment-note" id="paymentNote" placeholder="Payment Note">
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('#printButton').on('click', function() {
            ...
            if (qrCode === 'on') {
                ...
                if (sub_total === 'on') {
                    qrText += `Sub Total: Rs. ${finalAmounts.toFixed(2)}, `; // You can include the subtotal if you have it
                }
